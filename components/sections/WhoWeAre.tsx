...
export function WhoWeAre() {
  return (
    <section id="who-we-are" className="w-full py-20 sm:py-28 bg-red">
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid lg:grid-cols-[5fr_5fr] lg:items-center lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-4 flex flex-col gap-2.5">
              ...
              <p>
                Aurora XP is the platform that bridges that gap. Lenders
                provide capital directly to Aurora XP, and our team deploys

...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('MagicRings: WebGL context creation failed', err);
      return;
    }

    // The shader is plain GLSL ES 1.00 (no WebGL2-only syntax), so it runs
    // fine under WebGL1 too — don't bail out just because WebGL2 isn't
    // available, which silently blanked this out in some environments.
